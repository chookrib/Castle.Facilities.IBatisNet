...
namespace IBatisNet.Common.Utilities.Objects
{
    ...
    public sealed class ObjectProbe
    {
        ...
        static ObjectProbe()
        {
            ...
            //_simpleTypeMap.Add(LinkedList.class);
            //_simpleTypeMap.Add(HashSet.class);
            //_simpleTypeMap.Add(TreeSet.class);
            //_simpleTypeMap.Add(Vector.class);
            //_simpleTypeMap.Add(Hashtable.class);
