    ...
    public sealed class EnumTypeHandler : BaseTypeHandler
    {
        ...
        public override object GetValueByName(ResultProperty mapping, IDataReader dataReader)
        {
            ...
            else
            {
                //=================================================================
                //添加可空枚举支持
                if (mapping.MemberType.IsEnum)
                    return Enum.Parse(mapping.MemberType, dataReader.GetValue(index).ToString());
                else
                    return Enum.Parse(mapping.MemberType.GetGenericArguments()[0], dataReader.GetValue(index).ToString());
                //=================================================================
            }
        }
        ...
        public override object GetValueByIndex(ResultProperty mapping, IDataReader dataReader)
        {
            ...
            else
            {
                ...
                if (mapping.MemberType.IsEnum)
                    ...
                    return Enum.Parse(mapping.MemberType.GetGenericArguments()[0], dataReader.GetValue(mapping.ColumnIndex).ToString());
                //=================================================================
            }
        }
        ...
        public override object ValueOf(Type type, string s)
        {
            ...
            if (type.IsEnum)
                ...
                return Enum.Parse(type.GetGenericArguments()[0], s);
            //=================================================================
        }
        ...
        public override object GetDataBaseValue(object outputValue, Type parameterType)
        {
            ...
            if (parameterType.IsEnum)
                ...
                return Enum.Parse(parameterType.GetGenericArguments()[0], outputValue.ToString());
            //=================================================================
        }
